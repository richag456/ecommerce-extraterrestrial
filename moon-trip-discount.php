						...
						<section id="content">
							<div class="row">
								<div class="col-4 col-12-xsmall">
									<figure>
										<center><img src="images/moon.jpg" width="400" height="400" alt="Image" class="img-fluid"></center>
									</figure>
								...
								<div class="col-6 col-12-xsmall">
									<div class="px-4">
											...
											<ul class="alt">
												<li>
													Walk in the footsteps of Armstrong and Aldrin! Be among the first to experience the Earth's right hand man.
													<h4>Details:</h4>
													<ul>
												...
												<form action = "moon-trip-discount.php" method = "POST">
													<div class = "row">
														<div class = "column">
